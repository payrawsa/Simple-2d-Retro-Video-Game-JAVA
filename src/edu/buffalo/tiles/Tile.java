...
public abstract class Tile extends GameObject{
    ...
    /**
     * The content of the tile will encounter the creature. If that content is another creature the encountered
     * creature will also encounter the creature contained in the tile
